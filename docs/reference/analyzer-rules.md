...
- `dart_cloud_cli/lib/services/function_analyzer.dart` - Main analyzer implementation
- `dart_cloud_cli/lib/commands/deploy_command.dart` - Integration with deploy flow

## See Also

- [Deployment Configuration](./deployment-config.md) - Configuration and restrictions
